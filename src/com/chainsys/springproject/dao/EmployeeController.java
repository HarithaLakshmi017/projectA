...
import com.chainsys.springproject.commonutils.InvalidInputDataException;
import com.chainsys.springproject.commonutils.Validator;
	...
	public void getAllEmployee() {
		...
		while (empiterator.hasNext()) {
			...
			System.out.println(emp.getEmp_id() + " " + emp.getFirst_name() + " " + emp.getLast_name() + " "
					+ emp.getEmail() + " " + emp.getEmp_id() + " " + emp.getSalary());
		}
